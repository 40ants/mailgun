# -*- coding: utf-8 -*-
#
# mailgun documentation build configuration file, created by
...
latex_documents = [
  ('index', 'mailgun.tex', u'mailgun Documentation',
...
man_pages = [
    ('index', 'mailgun', u'mailgun Documentation',
